...
export default class MessagesPageAdmin {
    constructor(context) {
    ...
    init() {
        this._rootEl.innerHTML = `<div class="container h-100"><div class="h-100 d-flex flex-column">`+
            common.brand()+
            common.navSimple("menu-main", "/admin/main", "Shop")+
            common.navSimple("menu-news", "/admin/news", "Newsfeed")+
            common.navActive("menu-messages", "/admin/messages", "Messages")+
            common.navFooter()+
